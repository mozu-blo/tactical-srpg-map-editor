...
- 中ドラッグ／Shift＋右ドラッグによる水平移動、2本指ドラッグの回転／水平移動切替、中央に戻す
...
- **2本指**：ドラッグで視点変更または水平移動（カメラ欄で切替）、ピンチで拡大縮小します。
- **PC**：左クリックで編集、右ドラッグで視点変更、中ドラッグまたはShift＋右ドラッグで水平移動、ホイールで拡大縮小します。
- **表示**：Height表示で上面の数字を一括切替できます。中央に戻すと水平移動位置だけがリセットされます。
